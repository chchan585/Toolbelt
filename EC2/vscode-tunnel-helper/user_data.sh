...
wget -O /home/dev/code-server-install/start-code-server.sh https://raw.githubusercontent.com/chchan585/Toolbelt/main/EC2/vscode-tunnel-helper/start-code-server.sh
chmod 745 /home/dev/code-server-install/start-code-server.sh

## create start-code-server.service
wget -O /home/dev/code-server-install/start-code-server.service https://raw.githubusercontent.com/chchan585/Toolbelt/main/EC2/vscode-tunnel-helper/start-code-server.service
chmod 664 /home/dev/code-server-install/start-code-server.service

## get enable-code-server-service.sh from github
wget -O /home/dev/code-server-install/enable-code-server-service.sh https://raw.githubusercontent.com/chchan585/Toolbelt/main/EC2/vscode-tunnel-helper/enable-code-server-service.sh
...
## setup guide:
## 0. Set this in user data field or manually execute: "wget -O- https://raw.githubusercontent.com/chchan585/Toolbelt/main/EC2/vscode-tunnel-helper/user_data.sh | sh"
